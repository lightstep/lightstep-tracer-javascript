...
module.exports = {"name":"lightstep-tracer","version":"0.21.1","main":"index.js","engines":{"node":">=0.12.0"},"scripts":{"test":"rm -f test/results/*.json && node node_modules/mocha/bin/mocha -c test/unittest_node.js"},"license":"MIT","repository":{"type":"git","url":"http://github.com/lightstep/lightstep-tracer-javascript.git"},"dependencies":{"async":"1.5.0","eventemitter3":"1.1.1","google-protobuf":"3.6.1","hex2dec":"1.0.1","source-map-support":"0.3.3","thrift":"0.11.0"},"devDependencies":{"@babel/cli":"^7.0.0","@babel/core":"^7.0.0","@babel/plugin-check-constants":"^7.0.0-beta.38","@babel/plugin-transform-arrow-functions":"^7.0.0","@babel/plugin-transform-block-scoped-functions":"^7.0.0","@babel/plugin-transform-block-scoping":"^7.0.0","@babel/plugin-transform-classes":"^7.0.0","@babel/plugin-transform-computed-properties":"^7.0.0","@babel/plugin-transform-destructuring":"^7.0.0","@babel/plugin-transform-duplicate-keys":"^7.0.0","@babel/plugin-transform-literals":"^7.0.0","@babel/plugin-transform-modules-commonjs":"^7.0.0","@babel/plugin-transform-object-super":"^7.0.0","@babel/plugin-transform-parameters":"^7.0.0","@babel/plugin-transform-spread":"^7.0.0","@babel/plugin-transform-sticky-regex":"^7.0.0","@babel/plugin-transform-template-literals":"^7.0.0","@babel/plugin-transform-unicode-regex":"^7.0.0","@babel/polyfill":"^7.0.0","@babel/preset-env":"^7.0.0","babel-loader":"^8.0.0","babel-plugin-add-module-exports":"^1.0.0","chai":"3.4.1","clone":"1.0.2","colors":"1.1.2","eslint":"2.4.0","eslint-config-airbnb":"6.2.0","eslint-plugin-react":"4.2.3","express":"^4.16.3","istanbul":"^0.4.5","mocha":"^5.2.0","opentracing":"0.14.3","protobufjs":"6.8.8","shelljs":"0.5.3","sprintf-js":"1.0.3","underscore":"1.8.3","watch-trigger":"0.0.5","webpack":"^4.25.1","webpack-cli":"^3.1.2"}};
...
exports.LS_META_TRACER_CREATE = exports.LS_META_SP_FINISH = exports.LS_META_SP_START = exports.LS_META_INJECT = exports.LS_META_EXTRACT = exports.LS_META_TRACER_GUID_KEY = exports.LS_META_SPAN_KEY = exports.LS_META_TRACE_KEY = exports.LS_META_PROPAGATION_KEY = exports.LS_META_EVENT_KEY = exports.JOIN_ID_PREFIX = exports.LIGHTSTEP_APP_URL_PREFIX = exports.CLOCK_STATE_REFRESH_INTERVAL_MS = exports.LOG_STRING_TO_LEVEL = exports.LOG_LEVEL_TO_STRING = exports.LOG_FATAL = exports.LOG_ERROR = exports.LOG_WARN = exports.LOG_INFO = void 0;
var LOG_INFO = 0;
...
function () {
  ...
  _createClass(PlatformBrowser, [{
    ...
    value: function runtimeGUID(groupName) {
      ...
      // runtime GUID).
      var cookieKey = "".concat(kRuntimeGUIDCookiePrefix, "/").concat(groupName);
...
var coerce = _interopRequireWildcard(__webpack_require__(/*! ./coerce.js */ "./src/imp/coerce.js"));
...
var _util = _interopRequireDefault(__webpack_require__(/*! ./util/util.js */ "./src/imp/util/util.js"));
...
function (_opentracing$Span) {
  ...
  function SpanImp(tracer, name, spanContext) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SpanImp).call(this));
...
function (_opentracing$Tracer) {
  ...
  _createClass(Tracer, [{
    ...
    value: function _startSpan(name, fields) {
      ...
      var spanImp = new _span_imp.default(this, name, new _span_context_imp.default(this._platform.generateUUID(), traceGUID));
    ...
    value: function _injectToTextMap(spanContext, carrier) {
      ...
      if (typeof carrier !== 'object') {
        this._error("Unexpected '".concat(typeof carrier, "' FORMAT_TEXT_MAP carrier in call to inject"));

        return;
      }

      carrier["".concat(CARRIER_TRACER_STATE_PREFIX, "spanid")] = spanContext._guid;
      carrier["".concat(CARRIER_TRACER_STATE_PREFIX, "traceid")] = spanContext._traceGUID;
      spanContext.forEachBaggageItem(function (key, value) {
        carrier["".concat(CARRIER_BAGGAGE_PREFIX).concat(key)] = value;
      });
      carrier["".concat(CARRIER_TRACER_STATE_PREFIX, "sampled")] = 'true';
      return carrier;
    }
  }, {
    key: "_extract",
    ...
    value: function _extractTextMap(format, carrier) {
      ...
      var spanContext = new _span_context_imp.default(null, null); // Iterate over the contents of the carrier and set the properties
      // accordingly.
      ...
      (0, _each2.default)(carrier, function (value, key) {
        ...
        switch (suffix) {
          ...
          default:
            _this3._error("Unrecognized carrier key '".concat(key, "' with recognized prefix. Ignoring."));
      ...
      if (foundFields < 2) {
        ...
        this._error("Only found a partial SpanContext: ".concat(format, ", ").concat(carrier));
    ...
    value: function options(opts) {
      ...
      for (var key in opts) {
        if (modified[key] === undefined && unchanged[key] === undefined) {
          this._warn("Invalid option ".concat(key, " with value ").concat(opts[key]));
        }
      } //
    ...
    value: function _initReportingDataIfNeeded(modified) {
      ...
      (0, _each2.default)(this._options.tags, function (value, key) {
        if (typeof value !== 'string') {
          _this5._error("Tracer tag value is not a string: key=".concat(key));
    ...
    value: function _restoreRecords(spans, internalLogs, counters) {
      ...
      (0, _each2.default)(counters, function (value, key) {
        if (key in _this9._counters) {
          ...
          _this9._error("Bad counter name: ".concat(key));
        }
      });
    } //-----------------------------------------------------------------------//
    // Reporting loop
    ...
    value: function _flushReport(manual, detached, done) {
      ...
      this._transport.report(detached, this._auth, report, function (err, res) {
        ...
        if (err) {
          ...
          _this13._reportErrorStreak++; // On a failed report, re-enqueue the data that was going to be
          // sent.
          ...
          _this13._warn("Error in report: ".concat(errString), {
            last_report_seconds_ago: reportWindowSeconds
          });

          _this13._restoreRecords(report.getSpanRecords(), report.getInternalLogs(), report.getCounters()); // Increment the counter *after* the counters are restored
          ...
          if (_this13.verbosity() >= 4) {
            _this13._debug("Report flushed for last ".concat(reportWindowSeconds, " seconds"), {
          ...
          _this13._reportYoungestMicros = now; // Update the clock state if there's info from the report
  ...
  _createClass(InstrumentXHR, [{
    ...
    value: function _instrumentOpen() {
      ...
      return function (method, url, asyncArg, user, password) {
        ...
        var openPayload = {};
        (0, _each2.default)(tags, function (val, key) {
          openPayload[key] = val;
        });
        openPayload.cookies = getCookies(); // Note: async defaults to true
