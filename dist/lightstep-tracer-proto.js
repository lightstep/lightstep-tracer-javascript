...
/***/ function(module, exports, __webpack_require__) {
	...
	var _platform_abstraction_layer = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _auth_imp = __webpack_require__(36);
	
	var _auth_imp2 = _interopRequireDefault(_auth_imp);
	
	var _runtime_imp = __webpack_require__(37);
	
	var _runtime_imp2 = _interopRequireDefault(_runtime_imp);
	
	var _report_imp = __webpack_require__(39);
	...
	var Platform = __webpack_require__(40).Platform;
	var ProtoTransport = null;
	var ThriftTransport = null;
	if (true) {
	    ProtoTransport = __webpack_require__(40).ProtoTransport;
	}
	if (false) {
	    ThriftTransport = require('../platform_abstraction_layer').ThriftTransport;
	}
	
	var ClockState = __webpack_require__(47);
	var LogBuilder = __webpack_require__(48);
	var coerce = __webpack_require__(22);
	var constants = __webpack_require__(23);
	var globals = __webpack_require__(49);
	...
	var Tracer = function (_opentracing$Tracer) {
	    ...
	    function Tracer(opts) {
	        ...
	        _this._platform = new Platform(_this);
	        ...
	        if (!_this._transport) {
	            if (opts.transport && opts.transport === 'thrift') {
	                _this._transport = new ThriftTransport(logger);
	            } else {
	                _this._transport = new ProtoTransport(logger);
	            }
	        }
	        ...
	        // Built-in plugins
	        _this.addPlugin(__webpack_require__(51));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _log_record_imp = __webpack_require__(24);
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* global TRANSPORT_PROTO */
	
	var croutonThrift = null;
	var googleProtobufTimestampPB = null;
	var proto = null;
	var converter = null;
	if (true) {
	    googleProtobufTimestampPB = __webpack_require__(25);
	    proto = __webpack_require__(31);
	    converter = __webpack_require__(35);
	}
	if (false) {
	    ...
	    _createClass(SpanImp, [{
	        ...
	        value: function _toThrift() {
	            ...
	            if (false) {
	                var _ret = function () {
	                    var attributes = [];
	                    (0, _each3.default)(_this2._tags, function (value, key) {
	                    ...
	                    var logs = [];
	                    (0, _each3.default)(_this2._log_records, function (logRecord) {
	                    ...
	                    return {
	                        v: new croutonThrift.SpanRecord({
	                            span_guid: _this2.guid(),
	                            trace_guid: _this2.traceGUID(),
	                            runtime_guid: _this2._tracerImp.guid(),
	                            span_name: _this2._operationName,
	                            oldest_micros: _this2._beginMicros,
	                            youngest_micros: _this2._endMicros,
	                            attributes: attributes,
	                            error_flag: _this2._errorFlag,
	                            log_records: logs
	                        })
	                    };
	                }();
	        ...
	        value: function _toProto() {
	            ...
	            if (true) {
	                var _ret2 = function () {
	                    ...
	                    spanContextProto.setTraceId(converter.hexToDec(_this3.traceGUID()));
	                    spanContextProto.setSpanId(converter.hexToDec(_this3.guid()));
	
	                    var spanProto = new proto.Span();
	                    spanProto.setSpanContext(spanContextProto);
	                    spanProto.setOperationName(_this3._operationName);
	
	                    var startTimestamp = new googleProtobufTimestampPB.Timestamp();
	                    var startSeconds = Math.floor(_this3._beginMicros / 1000000);
	                    var startNanos = _this3._beginMicros % 1000000;
	                    startTimestamp.setSeconds(startSeconds);
	                    startTimestamp.setNanos(startNanos);
	                    spanProto.setStartTimestamp(startTimestamp);
	                    spanProto.setDurationMicros(_this3._endMicros - _this3._beginMicros);
	
	                    var logs = [];
	                    (0, _each3.default)(_this3._log_records, function (logRecord) {
	                    ...
	                    var tags = [];
	                    (0, _each3.default)(_this3._tags, function (value, key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* global TRANSPORT_PROTO */
	...
	var LogRecordImp = function () {
	    ...
	    _createClass(LogRecordImp, [{
	        ...
	        value: function toThrift() {
	            ...
	            if (false) {
	                var _ret = function () {
	                    _this._clearOverLimits();
	                    var thriftFields = [];
	                    (0, _each3.default)(_this._fields, function (value, key) {
	                        if (!key || !value) {
	                            return;
	                        }
	                    ...
	                    return {
	                        v: new croutonThrift.LogRecord({
	                            timestamp_micros: _this._timestampMicros,
	                            fields: thriftFields
	                        })
	                    };
	                }();
	        ...
	        value: function toProto() {
	            ...
	            if (true) {
	                var _ret2 = function () {
	                    _this2._clearOverLimits();
	                    var log = new proto.Log();
	                    var ts = new googleProtobufTimestampPB.Timestamp();
	                    var secs = Math.floor(_this2._timestampMicros / 1000000);
	                    var nanos = _this2._timestampMicros % 1000000;
	                    ts.setSeconds(secs);
	                    ts.setNanos(nanos);
	                    log.setTimestamp(ts);
	                    var keyValues = [];
	                    (0, _each3.default)(_this2._fields, function (value, key) {
	                        if (!key || !value) {
	                            return;
	                        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jspb = __webpack_require__(26);
	var goog = jspb;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var google_protobuf_timestamp_pb = __webpack_require__(25);
	var google_api_annotations_pb = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var google_api_http_pb = __webpack_require__(33);
	var google_protobuf_descriptor_pb = __webpack_require__(34);
	    ...
	    _createClass(RuntimeImp, [{
	        ...
	        value: function toThrift() {
	            ...
	            if (false) {
	                var _ret = function () {
	                    var thriftAttrs = [];
	                    (0, _each3.default)(_this._attributes, function (val, key) {
	                    ...
	                    return {
	                        v: new croutonThrift.Runtime({
	                            guid: _this._runtimeGUID,
	                            start_micros: _this._startMicros,
	                            group_name: _this._componentName,
	                            attrs: thriftAttrs
	                        })
	                    };
	                }();
	...
	var ReportImp = function () {
	    ...
	    _createClass(ReportImp, [{
	        ...
	        value: function toThrift() {
	            ...
	            if (false) {
	                var _ret = function () {
	                    (0, _each3.default)(_this._spanRecords, function (span) {
	                        span.runtime_guid = _this._runtimeGUID;
	                    });
	
	                    var thriftCounters = [];
	                    (0, _each3.default)(_this._counters, function (value, key) {
	                        if (value === 0) {
	                            return;
	                        }
	                    ...
	                    (0, _each3.default)(_this._spanRecords, function (spanRecord) {
	                        thriftSpanRecords.push(spanRecord._toThrift());
	                    });
	
	                    return {
	                        v: new croutonThrift.ReportRequest({
	                            runtime: _this._runtime.toThrift(),
	                            oldest_micros: _this._oldestMicros,
	                            youngest_micros: _this._youngestMicros,
	                            span_records: thriftSpanRecords,
	                            internal_logs: _this._internalLogs,
	                            internal_metrics: new croutonThrift.Metrics({
	                                counts: thriftCounters
	                            }),
	                            timestamp_offset_micros: _this._timestampOffsetMicros
	                        })
	                    };
	                }();
	        ...
	        value: function toProto(auth) {
	            ...
	            if (true) {
	                var _ret2 = function () {
	                    var spansList = [];
	                    (0, _each3.default)(_this2._spanRecords, function (spanRecord) {
	                        spansList.push(spanRecord._toProto());
	                    });
	
	                    var countsList = [];
	                    (0, _each3.default)(_this2._counters, function (count) {
	                    ...
	                    reportProto.setReporter(_this2._runtime.toProto());
	                    reportProto.setSpansList(spansList);
	                    reportProto.setTimestampOffsetMicros(_this2._timestampOffsetMicros);
	                    return {
	                        v: reportProto
	                    };
	                }();
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (true) {
	    module.exports = {
	        ...
	        ProtoTransport: __webpack_require__(46),
	        proto: __webpack_require__(31)
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var optionsParser = __webpack_require__(42);
	...
	var PlatformBrowser = function () {
	    ...
	    _createClass(PlatformBrowser, [{
	        ...
	        value: function plugins(opts) {
	            return [__webpack_require__(44), __webpack_require__(45)];
	        }
	    }, {
	        key: 'options',
...
/***/ function(module, exports) {
	...
	module.exports.parseScriptElementOptions = function (opts, browserOpts) {
	    ...
	    var transport = dataset.transport;
	    if (transport) {
...
;
//# sourceMappingURL=lightstep-tracer-proto.js.map